                ...
                <div class="col-md-7 col-12 p-4 bg-white">
                    ...
                    <div id="loginBox">
                        <div id="loginFields">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" placeholder="Enter your mobile number" autocomplete="username">
                            </div>
                            <div class="mb-3">
                    ...
                    <div id="registerBox" style="display:none">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Enter your full name" autocomplete="name">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Mobile Number</label>
                            <input type="tel" class="form-control" placeholder="Enter your mobile number" autocomplete="tel">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Email</label>
                            <input type="email" class="form-control" placeholder="Enter your email" autocomplete="email">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Password</label>
                            <div class="input-group">
                                <input type="password" class="form-control" id="regPassword" placeholder="Create a password" autocomplete="new-password">
