...
Route::get('/raju-maharaj', [RajuMaharajBookingController::class, 'showForm'])->name('booking.raju-maharaj.form');
Route::post('/raju-maharaj', [RajuMaharajBookingController::class, 'submit'])->name('booking.raju-maharaj.submit');
